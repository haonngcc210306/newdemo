    ...
    <form class="form form-vertical" method="POST" action="#" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="col-sm-10">
                        <input id="employeeid" type="text" name="employeeid" class="form-control" value="<?= $row['employID'] ?>" require>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="col-sm-10">
                        <input id="supplierID" type="text" name="supplierID" class="form-control" value="<?= $row['supplierID'] ?>" require>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="col-sm-10">
<input id="image" type="text" name="image" class="form-control" value="<?= $row['img'] ?>" require>
                    </div>
                </div>
            </div> 
